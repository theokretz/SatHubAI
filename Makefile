...
SOURCES = \
	__init__.py \
	sathub_ai.py sathub_ai_dialog.py

PLUGINNAME = sathub_ai

PY_FILES = \
	__init__.py \
	sathub_ai.py sathub_ai_dialog.py

UI_FILES = sathub_ai_dialog_base.ui
...
QGISDIR=C:\Users\Theo Kretz\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
